...
class AnnonceType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('zip', TextType::class, $this->getConfiguration("Code Postal", "Indiquez l'adresse de l'appartement !"))
            ->add('zip', TextType::class, $this->getConfiguration("adresse", "Indiquez l'adresse de l'appartement !"))
