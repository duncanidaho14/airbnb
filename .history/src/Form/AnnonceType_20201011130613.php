...
class AnnonceType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('lat', DecimalType::class, $this->getConfiguration("adresse", "Indiquez l'adresse de l'appartement !"))
            ->add('lon', DecimalType::class, $this->getConfiguration("adresse", "Indiquez l'adresse de l'appartement !"))
