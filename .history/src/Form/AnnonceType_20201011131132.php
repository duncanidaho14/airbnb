...
class AnnonceType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('lat', NumberType::class, $this->getConfiguration("Latitude", "Indiquez la latitude de l'appartement (!"))
            ->add('lon', NumberType::class, $this->getConfiguration("Longitude", "Indiquez la longitude de l'appartement !"))
